...
class ProposeMessage:
    block: Block
    greatest_justified_checkpoint: Checkpoint
    highest_candidate_block_hash: Hash
...
class NodeState(PRecord):
    ...
    votes: PSet[SignedVoteMessage] = field()
    vote_receival_times: PMap[SignedVoteMessage, int]
    greatest_justified_checkpoint: Checkpoint
    highest_candidate_block: Block
