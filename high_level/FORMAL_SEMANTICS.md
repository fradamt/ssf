...
The set of all functions decorated via `@MapEvent` defines the input event mapping function as 
$m_I(i) := \texttt{low\\_event\\_name}(a_1, a_2, \ldots, a_k)$ if $i = \langle \texttt{low\\_event\\_name}, a_1, a_2, \ldots, a_k \rangle$.
